...
- (void)viewDidLoad
{
    ...
    // 设置一排固定间距自动宽度子view
    [self setupAutoWidthViewsWithCount:3 margin:10];
...
- (void)setupAutoWidthViewsWithCount:(NSInteger)count margin:(CGFloat)margin
{
    ...
    [_autoWidthViewsContainer setupAutoWidthFlowItems:[temp copy] withPerRowItemsCount:count verticalMargin:margin horizontalMargin:margin verticalEdgeInset:5 horizontalEdgeInset:margin];
...
- (void)setupAutoMarginViewsWithCount:(NSInteger)count itemWidth:(CGFloat)itemWidth
{
    ...
    [_autoMarginViewsContainer setupAutoMarginFlowItems:[temp copy] withPerRowItemsCount:count itemWidth:itemWidth verticalMargin:10 verticalEdgeInset:4 horizontalEdgeInset:10];
